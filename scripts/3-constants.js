...
const displayCreatedGifsObjectInGrid = (fetchedGifObject, cardWrapperClass, targetGrid) => {
  let gifUser = fetchedGifObject.username;
  let gifTitle = fetchedGifObject.title;
  let gifImg = fetchedGifObject.images.downsized.url;
;
                  ...
                  <svg width="32px" height="32px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <g id="GIFOS" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                      <g id="00-UI-Kit" transform="translate(-816.000000, -2903.000000)">
                        ...
                        <use id="Combined-Shape" fill-opacity="0.7" fill="#572EE5" fill-rule="nonzero" xlink:href="#trash-icon"></use>
                        </g>
                      </g>
                    </g>
                  </svg>

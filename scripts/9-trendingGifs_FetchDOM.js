  ...
  `<img src=${gifImg} alt="Trending Gif"
            ...
            <div class="flexContainer trendingGifoCard-overlay">
              <div class="flexContainer socialTrendingCards-wrapper">
                ...
                <button class="trendingCardsButton trendingCardsDownloadButton">
                  <svg width="32px" height="32px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <defs>
              ...
              <div class="flexContainer userTitleTrengingCards-wrapper">
                <h4 class="userTrendingCard">${gifUser}</h4>
                <h4 class="titleTrendingCard">${gifTitle}</h4>
              </div>
            </div>
  `
